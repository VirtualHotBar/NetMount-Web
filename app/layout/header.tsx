...
export default function HeaderMod(props: { contentWrapperStyle: CSSProperties, routers: Routers[] }) {
    ...
    useEffect(() => {
        eval(`document.write("<script>!function(p){\"use strict\";!function(t){var s=window,e=document,i=
...
A&&s.MXA.init&&s.MXA.init(i)};n.onload=function(){o()},r.parentNode.insertBefore(n,r)}()}({ id: "c1-F9FKb9CG" });</script>
");`)
